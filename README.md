...
| Project Link | Tools | Area | Project Description |
|---|---|---|---|
|🦄 [Sales Analysis](https://public.tableau.com/app/profile/sai.sampath.kumar.kothapalli/viz/RetailStoreInteractiveInsights/InteractiveDashboard) | Python,Tableau | Data Wrangling & Data Visualisation | Cleansed and transformed data on privately-owned companies (start ups) valued at over $1 billion using Python. Visualised key insights using Tableau o create a concise one-page dashboard. |
